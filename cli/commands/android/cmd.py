...
def list_cmd(filter: str | None) -> None:
    ...
    """
    from cli.commands.android.adb import check_adb, list_packages
...
def pull(package: str, output: str | None) -> None:
    ...
    """
    from cli.commands.android.adb import check_adb, get_apk_paths, pull_apks
...
def install(apk_path: str) -> None:
    ...
    from cli.commands.android.adb import check_adb, install_apk
...
def cert(cert_path: str | None) -> None:
    ...
    """
    from cli.commands.android.adb import check_adb, push_cert
